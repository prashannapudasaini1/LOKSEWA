...
const navItems: NavItem[] = [
  ...
  { name: "Profile", path: "/admin/admindashboard/profile", icon: UserCircleIcon },
  { name: "Applicants", path: "/admin/admindashboard/applicants", icon: FolderMinusIcon },
  { name: "Exams", path: "/admin/admindashboard/adminexam", icon: BookOpenIcon },
...
const Sidebar: React.FC = () => {
  return (
    <aside className="flex flex-col w-64 h-screen bg-[#F5EFE6] text-gray-800 shadow-lg">
      ...
      <Link
        to="/"
        className="block px-6 py-4 text-2xl font-bold text-black hover:text-[#1E90FF] transition-colors"
      >
        LOKSEWA
      </Link>
